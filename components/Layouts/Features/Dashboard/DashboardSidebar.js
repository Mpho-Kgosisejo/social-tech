...
import { Icon, Menu, Sidebar, Breadcrumb, Divider, Container, Dimmer } from 'semantic-ui-react'
...
import DashboardCateringPage from './DashboardPages/DashboardCateringPage';
        ...
        return (
            <div>
                ...
                <Sidebar.Pushable className="dashboard-sidebar-pushable">
                    ...
                    <Menu.Item className="fresheats-brown-color" as='a' onClick={() => { this.changeActivePage("Catering")}}>
                        <Icon name='food' />
                        Catering
                    </Menu.Item>
                    <Divider/>
                    ...
                    <Sidebar.Pusher className="dashboard-sidebar-pushable"> 
                        ...
                        <Dimmer active={openSidebar} onClickOutside={() => this.showSideBars()} />
                    </Sidebar.Pusher>
                </Sidebar.Pushable>
            </div>
        )
